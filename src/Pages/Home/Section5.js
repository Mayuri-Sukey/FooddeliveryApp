         ...
         <Carousel.Caption>
           <div className='d-flex align-items-center justify-content-between'>
             <div className='brand_img'>
                <img src={Brand1} className="img-fluid me-3" alt="brand-1"/>
             </div>
             <div className='brand_img'>
                <img src={Brand2} className="img-fluid me-3" alt="brand-1"/>
             </div>
             <div className='brand_img'>
                <img src={Brand3} className="img-fluid me-3" alt="brand-1"/>
             </div>
             <div className='brand_img'>
                <img src={Brand4} className="img-fluid me-3" alt="brand-1"/>
             </div>
             <div className='brand_img'>
                <img src={Brand5} className="img-fluid me-3" alt="brand-1"/>
             </div>
             <div className='brand_img'>
                <img src={Brand6} className="img-fluid me-3" alt="brand-1"/>
             </div>
           </div>
        </Carousel.Caption>
      </Carousel.Item>
      ...
      <Carousel.Item>
         <Carousel.Caption>
           <div className='d-flex align-items-center justify-content-between'>
             ...
             <div className='brand_img'>
                <img src={Brand7} className="img-fluid me-3" alt="brand-1"/>
             </div>
             <div className='brand_img'>
                <img src={Brand8} className="img-fluid me-3" alt="brand-1"/>
             </div>
           </div>
        </Carousel.Caption>
      </Carousel.Item>
